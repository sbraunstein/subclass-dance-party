...
var DeanDancer = function(top, left, timeBetweenSteps){
	AnimatedDancer.call(this, top, left, timeBetweenSteps);
	this.timeBetweenSteps = timeBetweenSteps;
	this.$node = $('<div class="animatedDancer"><img src="http://38.media.tumblr.com/a4a04a7621085b39f27d3db61dd0b79a/tumblr_mt31gdGCAU1rf3zr7o3_400.gif" height="140" width="140"></div>');
	this.setPosition(top, left);
	this.speed = 500;
}
DeanDancer.prototype = Object.create(AnimatedDancer.protoype);
